...
class MusicServiceTest {
    ...
    private static class FakeMusic implements Music {
        ...
        @Override
        public void pause() { /* not used in tests */ }
        ...
        @Override
        public void setPan(float pan, float volume) { /* not used in tests */ }
        ...
        @Override
        public void setPosition(float position) { /* not used in tests */ }

        @Override
        public void dispose() { /* not used in tests */ }

        @Override
        public void setOnCompletionListener(OnCompletionListener listener) { /* not used in tests */ }
    }
