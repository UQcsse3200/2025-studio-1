...
public class SecurityGameArea extends GameArea {
  ...
  private void spawnEnemies() {
    ...
    Entity vroomba = com.csse3200.game.entities.factories.characters.NPCFactory.createVroomba(player, 1.2f);
    spawnEntityAt(vroomba, new GridPoint2(4, 6), true, false);

    Entity deepspin = com.csse3200.game.entities.factories.characters.NPCFactory.createDeepspin(player, this, 1.2f);
